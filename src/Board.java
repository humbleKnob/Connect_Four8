...
////(failed) Algorithm too make the CPU a little more intellegent
//public int checkMove(String token) {
...
//                        if (grid[row2][col2].equals(token) &&
//                                grid[row2 + 1][col2].equals(token) &&
//                                grid[row2 + 2][col2].equals(token)) {
//                            return col2;
//                        }
//                    }
//                }
